...
import { papers, regions, type Paper } from "@/data/records";
...
export default function PapersPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="font-display text-3xl">Papers</h1>
      <div className="toolbar">
        <input className="input" placeholder="Search papers…" value={q} onChange={e=>setQ(e.target.value)} />
